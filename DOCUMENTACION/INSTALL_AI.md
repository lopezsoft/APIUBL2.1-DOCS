...
Crear o actualizar `.env.local` (reemplaza con tus credenciales reales):
...
⚠️ Asegúrate que `.env.local` esté en `.gitignore` para prevenir exposición de credenciales.
