...
Cada item exitoso procesado por la DIAN retorna un **`document_uuid`**. **Debe extraer y almacenar este UUID en su sistema** una vez finalice el lote. Si el lote es purgado y usted no guardó el UUID, **no podrá ubicar ni consultar el documento** generado posteriormente.
:::
